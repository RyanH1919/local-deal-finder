...
- business_name: null if no specific business is named
...
- deal_description: 1-2 sentences, plain English — focus on the deal terms (what you get and for how much), omit backstory
