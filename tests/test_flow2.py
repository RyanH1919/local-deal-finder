...
def test_places_pagination():
    ...
    # Non-food keyword so this stays a pure pagination test (2 pages = 2 calls).
    # Food items additionally trigger a second 'meal_takeaway' search — covered elsewhere.
    res = places.find_nearby(43.70, -79.40, "electronics", radius_m=1000)
